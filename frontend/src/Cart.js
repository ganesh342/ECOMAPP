...
const Cart = () => {
  ...
  const handleCheckout = async () => {
    ...
    const res = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/auth/create-checkout-session`, {
      cartItems,
    });
      ...
      <div className="container">
        ...
        <div className="order-total--amount">
          <div className="order-total--subdata">
            ...
            <div>
              <Button className="btn-buy" onClick={handleCheckout}>Buy Now</Button>
            </div>
          </div>
        </div>
      </div>
